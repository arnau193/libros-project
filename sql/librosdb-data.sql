...
insert into resenas (idlibro, username, name,texto) values ('15', 'alicia', 'Alicia','Res libro0');
insert into resenas (idlibro, username, name,texto) values ('1', 'blas', 'Blas','Res libro1');
insert into resenas (idlibro, username, name,texto) values ('11', 'blas', 'Blas','Res libro2');
insert into resenas (idlibro, username, name,texto) values ('12', 'alicia', 'Alicia','Res libro3');
insert into resenas (idlibro, username, name,texto) values ('13', 'blas', 'Blas','Res libro4');
insert into resenas (idlibro, username, name,texto) values ('14', 'alicia', 'Alicia','Res libro5');
insert into resenas (idlibro, username, name,texto) values ('10', 'alicia', 'Alicia','Res libro6');
insert into resenas (idlibro, username, name,texto) values ('1', 'alicia', 'Alicia','Res libro7');
insert into resenas (idlibro, username, name,texto) values ('2', 'blas', 'Blas','Res libro8');
insert into resenas (idlibro, username, name,texto) values ('3', 'blas', 'Blas','Res libro9');
insert into resenas (idlibro, username, name,texto) values ('4', 'alicia', 'Alicia','Res libro10');
insert into resenas (idlibro, username, name,texto) values ('5', 'blas', 'Blas','Res libro11');
insert into resenas (idlibro, username, name,texto) values ('6', 'alicia', 'Alicia','Res libro12');
insert into resenas (idlibro, username, name,texto) values ('7', 'alicia', 'Alicia','Res libro13');
insert into resenas (idlibro, username, name,texto) values ('8', 'blas', 'Blas','Res libro14');
insert into resenas (idlibro, username, name,texto) values ('9', 'alicia', 'Alicia','Res libro16');
insert into resenas (idlibro, username, name,texto) values ('2', 'alicia', 'Alicia','Res libro17');
insert into resenas (idlibro, username, name,texto) values ('3', 'blas', 'Blas','Res libro18');
insert into resenas (idlibro, username, name,texto) values ('14', 'blas', 'Blas','Res libro20');
insert into resenas (idlibro, username, name,texto) values ('10', 'blas', 'Blas','Res libro22');
insert into resenas (idlibro, username, name,texto) values ('2', 'blas', 'Blas','Res libro23');
insert into resenas (idlibro, username, name,texto) values ('7', 'blas', 'Blas','Res libro25');
insert into resenas (idlibro, username, name,texto) values ('9', 'test', 'Test','Res libro24');
insert into resenas (idlibro, username, name,texto) values ('7', 'test', 'Test','Res libro25');
insert into resenas (idlibro, username, name,texto) values ('1', 'test', 'Test','Res libro24');
insert into resenas (idlibro, username, name,texto) values ('2', 'test', 'Test','Res libro25');